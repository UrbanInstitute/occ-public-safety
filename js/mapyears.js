//define how to add & style point layers
...
//define a function for each map with the layers to call, draw map based on those layers in the function - then in the html, call the specified map function
function assaultmap() {
    var assaultlayers = [{
            name: "2000",
